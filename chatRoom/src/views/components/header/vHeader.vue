<template>
  <div class="vchat-header">
    <div
      class="vchat-main-header"
      v-if="isMainHeader"
    >
      <div class="vchat-header-container">
        <div class="vchat-logo">Qchat</div>
    ...
    <div
      class="vchat-little-header"
      v-else
    >
      <div>
        <router-link to="/main/personalMain">qchat</router-link>
        <span
          class="logout"
          @click="$router.push({name: 'personalMain'})"
        >[返回]</span>
      </div>
      <div class="avatar">
        <a href="javascipt:;">
